...
Messages ==
  ...
  (* such a message.                                                       *)
  (*************************************************************************)
  [type : {"RMPrepared", "RMAborted"}, rm : RM]  \cup  [type : {"Commit", "Abort"}]
...
RMPrepare(r) == 
  ...
  /\ msgs' = msgs \cup {[type |-> "RMPrepared", rm |-> r]}
...
RMChooseToAbort(r) ==
  ...
  /\ msgs' = msgs \cup {[type |-> "RMAborted", rm |-> r]} \* Sends an abort message to the TM
  /\ UNCHANGED <<tmState, tmPrepared>>
...
TPNext ==
  \/ TMCommit 
  \/ \E r \in RM : 
       TMRcvPrepared(r) \/ RMPrepare(r) \/ RMChooseToAbort(r) \/ TMRcvAborted(r)
...
\* Last modified Fri Jan 13 11:04:56 CET 2023 by burcuozkan
